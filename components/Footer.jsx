...
const Footer = () => {
  return (
    <footer id="footer" className="bg-transparent border-t border-rose/10 pt-16 pb-8 text-black mt-10">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12 mb-12 text-right">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li className="flex items-center gap-2 justify-end">
              <span style={{direction: 'ltr'}}>01070504728</span>
              <a href="#">
          ...
          <div className="flex gap-4 mt-6 justify-end">
            <a href="https://www.instagram.com/noury_glossy?igsh=MTIybHlpc2QwdGN3YQ==" className="bg-pink-100 p-2 rounded-full text-[#BB015E] hover:bg-[#BB015E] hover:text-white transition-all">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
            </a>
            <a href="https://www.facebook.com/share/1Hrw4eXpZt/?mibextid=wwXIfr" className="bg-pink-100 p-2 rounded-full text-[#BB015E] hover:bg-[#BB015E] hover:text-white transition-all">
